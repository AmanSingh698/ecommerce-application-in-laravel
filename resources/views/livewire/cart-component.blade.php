                            ...
                            <table class="table shopping-summery text-center clean">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="action" data-title="Remove" wire:click.prevent="destroy('{{$item->rowId}}')"><a href="#" class="text-muted"><i class="fi-rs-trash"></i></a></td>
                                    </tr>
                                    @endforeach
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="cart_total_label">Tax Amount</td>
